      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-24 md:pt-48 md:pb-32">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Experience the next evolution of messaging. Real-time typing
              indicators, secure end-to-end encryption, and a beautifully
              crafted interface that makes every conversation a delight.
            </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <button
                        onClick={() => router.push("/login")}
                        className="flex items-center justify-center gap-2 p-3 rounded-xl bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-800 transition-all group/btn"
                      >
        ...
        <div id="features" className="mt-24 mb-32 relative">
          ...
          <div className="text-center mb-16 relative z-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-white">
              Why users love PulseChat
            </h2>
            <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              Built for speed, designed for clarity. Everything you need to
            ...
            {[
              {
                ...
                desc: "End-to-end encrypted messaging via Socket.IO ensuring your conversations stay private.",
                color: "text-emerald-400",
              },
              {
                icon: Zap,
                title: "Lightning Fast",
                desc: "Powered by WebSocket technology for sub-100ms latency real-time communication.",
                color: "text-amber-400",
              },
              {
                icon: Sparkles,
                title: "Modern Design",
                desc: "A beautifully crafted glassmorphism UI with smooth 60fps animations.",
                color: "text-purple-400",
              },
              {
                icon: Wifi,
                title: "Real-time Sync",
                desc: "Instant synchronization across all your devices. Never miss a message.",
                color: "text-sky-400",
              },
              {
                icon: Users,
                title: "Group Chats",
                desc: "Create unlimited groups and collaborate with your team effortlessly.",
                color: "text-rose-400",
              },
              {
                icon: CheckCircle2,
                title: "Read Receipts",
                desc: "Know exactly when your messages are delivered and read.",
                color: "text-blue-400",
              },
            ].map((feature, i) => (
              <motion.div
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl bg-slate-100 dark:bg-slate-800/80 flex items-center justify-center mb-4 mx-auto md:mx-0 ${feature.color} group-hover:scale-110 transition-transform`}
                >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
              <div className="flex-1 space-y-6 text-center md:text-left">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  PulseChat started as a passion project to simplify real-time
                  communication. We believe messaging should be instantaneous,
                  distraction-free, and beautiful.
                </p>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Built with the latest web technologies like Next.js,
                  Socket.IO, and Tailwind CSS, we push the boundaries of what's
        ...
        <div id="contact" className="mb-24 max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a
              href="mailto:hello@pulsechat.dev"
              className="p-4 rounded-xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 hover:border-sky-500/50 transition-colors flex items-center justify-center gap-3 group"
            >
            ...
            <a
              href="https://twitter.com/pulsechat"
              target="_blank"
              rel="noopener noreferrer"
              className="p-4 rounded-xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 hover:border-violet-500/50 transition-colors flex items-center justify-center gap-3 group"
            >
          ...
          <div className="mt-16 pt-8 border-t border-slate-800/50 text-slate-500 text-sm">
            <p>
              &copy; {new Date().getFullYear()} PulseChat. All rights reserved.
            </p>
